...
public class PasswordCrackerMasterMain {
    public static void main(String[] args) {
        ...
        try {
            ...
            HashMap<String, Integer> workerInfoMap = (HashMap<String, Integer>) parser.parse(new FileReader("/home/vicente/PasswordCrackerThrift/PasswordCrackerMaster/WorkerInfoList.json"));
